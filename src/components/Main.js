  ...
  render() {
    return (
      ...
      <main className="text-justify ">
        <p className="text-justify">  <span className="font-weight-bold">Grace Brewster Murray Hopper</span>(née <span className="font-weight-bold"> Murray</span>; December 9, 1906 – January 1, 1992) was an American
    ...
    <a href="https://en.wikipedia.org/wiki/Arleigh_Burke-class_destroyer" target="_blank">Arleigh Burke-class</a> guided-missile destroyer USS Hopper was named for her, as was the Cray XE6 "Hopper" supercomputer at NERSC During her lifetime, Hopper was awarded 40 honorary degrees from universities across the world. In 1991, she received the National Medal of Technology. On November 22, 2016, she was posthumously awarded the Presidential Medal of Freedom by President Barack Obama.</p>
        ...
        <h3 className="font-weight-bold pt-3">Career</h3>
        <ol>
          <li>World War II</li>
          <li>UNIVAC</li>
          <li>COBOL</li>
        ...
        <h2 className="font-weight-bold pt-3">Phrase</h2>
